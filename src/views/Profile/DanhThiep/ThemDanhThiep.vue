<template>
  <div class="container">
    ...
    <div class="p-3 bradius20 mt-5" style="background-color: #f4f4f4">
      <h2 class="text-center mb-4" style="font-size: 20px; font-weight: bold">Thêm danh thiếp</h2>
      ...
      <div class="d-flex justify-content-center">
        <div class="modal-content-thongbao" v-if="statusCode == 200">
          <div class="modal-header f-flex flex-column m-auto p-4" style="color: green">
            ...
            <span> Thêm danh thiếp thành công !</span>
          </div>
...
<script>
import { postAddDanhThiep } from '@/assets/js/userSevice'
  ...
  methods: {
    ...
    async updateProfile() {
      ...
      if (this.isValidFName && this.isValidLName && this.isValidPhone) {
        try {
          const res = await postAddDanhThiep(
            user_id,
