<template>
  <div class="container">
    ...
    <div class="p-3 bradius20 mt-5" style="background-color: #f4f4f4">
      <h2 class="text-center mb-4" style="font-size: 20px; font-weight: bold">Thêm liên kết</h2>
      ...
      <div class="d-flex justify-content-center">
        <div class="modal-content-thongbao" v-if="statusCode == 200">
          <div class="modal-header f-flex flex-column m-auto p-4" style="color: green">
            ...
            <span> Thêm liên kết thành công !</span>
          </div>
...
<script>
import { postAddLienKet } from '@/assets/js/userSevice'
...
export default {
  ...
  methods: {
    ...
    async addURL() {
      ...
      if (this.url) {
        try {
          const res = await postAddLienKet(user_id, this.name, this.url, this.status)
